...
public class SettingsWindow extends JFrame {
    ...
    SettingsWindow(GameWindow gameWindow) {
        ...
        btnStart.addActionListener(e -> {
            gameWindow.startNewGame(humanVsAi.isSelected() ? GameModes.HUMAN_VS_AI : GameModes.HUMAN_VS_HUMAN,
                    fieldSlider.getValue(), fieldSlider.getValue(), winLengthSlider.getValue());
            setVisible(false);
        });
        add(panBottom);
        setVisible(true);
